            ...
            @foreach($doctors as $doctor)
                <tr>
                    ...
                    <td class="d-flex gap-2">
                        <a href="{{ route('doctors.show', ['doctor' => $doctor->id]) }}" class="btn btn-primary btn-sm">Show</a>
                        <a href="{{ route('doctors.edit', ['doctor' => $doctor->id]) }}" class="btn btn-warning btn-sm">Edit</a>
